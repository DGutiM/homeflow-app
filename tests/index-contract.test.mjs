...
assert.match(html, /Intereses cobrados por año/);
...
assert.match(app, /HomeFlowCore\.mergeDepositSources/);
assert.match(app, /HomeFlowCore\.groupInvestmentInterestByYear/);
assert.match(app, /bundle\.deposits = structuredClone\(profile\?\.deposits \|\| \[\]\)/);
assert.match(app, /id: 'income_altan', label: 'Altan'/);
assert.match(html, /id="deposit-active-capital"/);
assert.match(app, /data-add-savings-interest/);
